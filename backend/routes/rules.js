...
const { getRules, getRulesByClient, updateRule, createUserRule, deleteRule } = require("../controllers/ruleController");
...
router.delete("/:id", verifyToken, requireAdmin, deleteRule);
